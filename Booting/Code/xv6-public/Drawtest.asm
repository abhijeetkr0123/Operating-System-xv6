...
int main(void){
  ...
  16:	68 d0 07 00 00       	push   $0x7d0
  1b:	e8 80 06 00 00       	call   6a0 <malloc>
  ...
  28:	89 c3                	mov    %eax,%ebx
    int x = draw(buffer, MAX);
  2a:	e8 54 03 00 00       	call   383 <draw>
    if(x<0){
  2f:	83 c4 10             	add    $0x10,%esp
  32:	85 c0                	test   %eax,%eax
  34:	78 2a                	js     60 <main+0x60>
  ...
  3c:	68 ba 07 00 00       	push   $0x7ba
  41:	6a 01                	push   $0x1
  43:	e8 f8 03 00 00       	call   440 <printf>
        printf(1, "%s\n", (char *)buffer);
  48:	83 c4 0c             	add    $0xc,%esp
  4b:	53                   	push   %ebx
  4c:	68 be 07 00 00       	push   $0x7be
  51:	6a 01                	push   $0x1
  53:	e8 e8 03 00 00       	call   440 <printf>
  58:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  5b:	e8 83 02 00 00       	call   2e3 <exit>
        printf(1, "Small buffer size");
  60:	52                   	push   %edx
  61:	52                   	push   %edx
  62:	68 a8 07 00 00       	push   $0x7a8
  67:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb c2 07 00 00       	mov    $0x7c2,%ebx
        while(*s != 0){
